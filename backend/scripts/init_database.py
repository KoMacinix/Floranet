...
def init_database():
    ...
    try:
        ...
        print("  2. Le fichier .env est-il correctement rempli?")
        print(f"  3. La base '{DatabaseConfig.NAME}' existe-t-elle?")
        print(f"\nPour créer la base:")
        print(f"  psql -U {DatabaseConfig.USER}")
        print(f"  CREATE DATABASE {DatabaseConfig.NAME};")
